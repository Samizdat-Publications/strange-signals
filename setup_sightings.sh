...
echo "  data/sightings_ufo.json.gz                   - UFO/UAP records (~14 MB gzipped)"
echo "  data/sightings_bigfoot.json.gz               - Bigfoot/Sasquatch records (~150 KB)"
echo "  data/sightings_haunted.json.gz               - Haunted Place records (~300 KB)"
...
echo "  UFO_CORGIS_80K      - CORGIS UFO sightings with nested columns (~60K)"
echo "  UFO_Wlouie1_80K     - wlouie1 NUFORC geocoded (~80K)"
echo "  Combined_All        - Deduplicated union of all datasets (~258K)"
echo ""
