...
DATA PIPELINE (Python 3)
  ...
  data/
    ...
    nasa_fireballs.json        877 NASA CNEOS located bolides, global 1988-present (committed)
...
- **Canonical branch is `master`.** PR against `master`. (`main` previously diverged and has been consolidated into `master`.)
